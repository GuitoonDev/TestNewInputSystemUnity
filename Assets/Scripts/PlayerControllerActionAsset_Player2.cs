...
public class PlayerControllerActionAsset_Player2 : MonoBehaviour
{
    ...
    [SerializeField] private InputActionAsset playerInputActionAsset; // ça marche pas !
    // STOP, C'EST FINI !!  //
    //////////////////////////
    ...
    private void Awake() {
        ...
        playerInputActions.Player2.Debug.started += ctx => {
            Debug.Log("Player.Debug.started");
        };

        playerInputActions.Player2.Debug.performed += ctx => {
            Debug.Log("Player.Debug.performed");
        };

        playerInputActions.Player2.Debug.canceled += ctx => {
    ...
    private void Update() {
        /////////////////////////
        // IL FAUT LIRE ICI !! //
        directionX = playerInputActions.Player2.Move.ReadValue<float>();
        bool isSlashButtonWasPressedThisFrame = playerInputActions.Player2.Slash.triggered;
        bool isJumpButtonPressedThisFrame = playerInputActions.Player2.Jump.triggered;
        // STOP, C'EST FINI !!  //
        //////////////////////////
